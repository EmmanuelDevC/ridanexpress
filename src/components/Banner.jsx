...
import ridanBreadImage from "../assets/Images/banner/ridanBread.png";
        ...
        <div className="container mx-auto sm:px-4">
            <div className="flex flex-col lg:flex-row mb-3 gap-2 lg:gap-3">
                    ...
                    <div className="absolute z-30 flex -translate-x-1/2 bottom-5 left-1/2 space-x-2">
                        {carouselImages.map((_, index) => (
                            <button
                                key={index}
                                type="button"
                                className={`w-8 h-1.5 rounded-full transition-all duration-300 ${index === currentSlide
                                        ? 'bg-white w-10'
                                        : 'bg-white/50'
                                    }`}
                ...
                <div className="lg:w-[35%] w-full grid grid-cols-2 gap-2 sm:gap-4">
                    {/* XclusivePlus Card */}
                    <div className="relative rounded-xl overflow-hidden shadow h-[150px] sm:h-[200px] group">
                        <img
                            src={ridanBreadImage}
                            alt="XclusivePlus"
                    ...
                    {/* Interest Card */}
                    <div className="relative rounded-xl overflow-hidden shadow h-[150px] sm:h-[200px] bg-gradient-to-br from-blue-600 to-indigo-700 p-4 flex flex-col justify-center items-center group">
